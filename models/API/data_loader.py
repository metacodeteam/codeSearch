...
class CodeSearchDataset(data.Dataset):
    ...
    def __init__(self, data_dir, f_api=None, max_api_len=None, f_descs=None, max_desc_len=None):
        ...
        assert self.idx_descs.shape[0] == self.idx_apis.shape[0]
    ...
    def __getitem__(self, offset):
        ...
        len, pos = self.idx_apis[offset][0], self.idx_apis[offset][1]
        api_len = min(int(len), self.max_api_len)
        api = self.apis[pos: pos + api_len]
        ...
        return api, api_len, good_desc, good_desc_len, bad_desc, bad_desc_len
