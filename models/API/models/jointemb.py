...
class JointEmbeder(nn.Module):
    def __init__(self, config):
        ...
        self.api_encoder = SeqEncoder(config['n_api_words'], config['emb_size'], config['lstm_dims'])
    ...
    def code_encoding(self, api, api_len):
    ...
    def forward(self, apiseq, api_len, desc_anchor, desc_anchor_len, desc_neg,
                desc_neg_len):
        # code_repr: [batch_sz x n_hidden]  
        code_repr = self.code_encoding(apiseq, api_len)
