...
class MultiEmbeder(nn.Module):
    ...
    def code_encoding(self, token, token_len, tree, tree_node_num, graph_init_input_batch, graph_adjmat_batch,
                      graph_node_mask):
        ...
        concat_feat = torch.cat((tok_feat_attn, ast_feat_attn, graph_feat_attn), 1)
    ...
    def forward(self, tokens, tok_len, tree, tree_node_num, cfg_init_input, cfg_adjmat, cfg_node_mask, desc_anchor,
