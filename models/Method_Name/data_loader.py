...
class CodeSearchDataset(data.Dataset):
    ...
    def __init__(self, data_dir, f_name=None, max_name_len=None, f_descs=None, max_desc_len=None):
    ...
    def __getitem__(self, offset):
        ...
        return name, name_len, good_desc, good_desc_len, bad_desc, bad_desc_len
