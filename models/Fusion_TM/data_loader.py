...
def batcher(device):
    def batcher_dev(batch):
        ...
        tokens, tok_len, init_input, adjmat, node_mask, good_desc, good_desc_len, bad_desc, bad_desc_len = zip(*batch)
...
class CodeSearchDataset(data.Dataset):
    ...
    """
    def __init__(self, config, data_dir, f_token, max_tok_len, f_cfgs, max_node_num, f_desc, max_desc_len):
