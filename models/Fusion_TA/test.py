...
def test(config, model, device):
    ...
    with open(save_path+sim_result_filename,'w+'),open(save_path+rank_result_filename,'w+'):
...
def parse_args():
    ...
    parser.add_argument('--reload_from', type=int, default=50, help='epoch to reload from')
