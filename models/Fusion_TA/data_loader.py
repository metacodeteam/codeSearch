...
def batcher(device):
    def batcher_dev(batch):
        ...
        tokens, tok_len, tree, tree_node_num, good_desc, good_desc_len, bad_desc, bad_desc_len = zip(*batch)
        ...
        return tokens, tok_len, tree, tree_node_num, good_desc, good_desc_len, bad_desc, bad_desc_len
    return batcher_dev
...
class CodeSearchDataset(data.Dataset):
    ...
    """
    def __init__(self, config, data_dir, f_token, max_tok_len, f_ast, f_ast_dict, f_desc, max_desc_len):
