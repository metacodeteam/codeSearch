...
def sents2indexes(sent_file_path, vocab_file_path, maxlen):
    phrases, indices = [], []
    with open(sent_file_path, 'r',encoding='utf-8') as sent_file:
...
def parse_args():
    parser = argparse.ArgumentParser("Parse Description data for GraphEmbedder")
    ...
    parser.add_argument('--desc_word_num', type=int, default=50)
    parser.add_argument('--desc_maxlen', type=int, default=50)
