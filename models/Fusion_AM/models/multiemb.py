...
class MultiEmbeder(nn.Module):
    ...
    def forward(self, tree, tree_node_num, cfg_init_input, cfg_adjmat, cfg_node_mask, desc_anchor, desc_anchor_len, desc_neg, desc_neg_len):
