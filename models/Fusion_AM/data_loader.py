...
def batcher(device):
    def batcher_dev(batch):
        ...
        tree, tree_node_num, init_input, adjmat, node_mask, good_desc, good_desc_len, bad_desc, bad_desc_len = zip(*batch)
...
class CodeSearchDataset(data.Dataset):
    ...
    """
    def __init__(self, config, data_dir, f_ast, f_ast_dict, f_cfgs, max_node_num, f_desc, max_desc_len):
    ...
    def __getitem__(self, offset):      
        ...
        init_input, adjmat, node_mask = get_one_mix_npy_info(self.graph_dict[str(offset)], self.max_node_num,
